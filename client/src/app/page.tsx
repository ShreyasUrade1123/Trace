  ...
  useEffect(() => {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        scrub: true,
        onEnter: () => {
          gsap.fromTo(sb, { y: 100, opacity: 0, display: 'flex' }, { y: 0, opacity: 1, duration: 0.5, ease: "power3.out" });
        },
        onLeaveBack: () => {
          gsap.to(sb, { y: 100, opacity: 0, duration: 0.3, ease: "power3.in", onComplete: () => gsap.set(sb, { display: "none" }) });
        }
      }
    });
