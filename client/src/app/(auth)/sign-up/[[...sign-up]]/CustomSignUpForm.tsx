...
const CustomSignUpForm = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F0F0F0] relative overflow-hidden flex items-center justify-center p-6 font-sans text-black">
                ...
                <div className="backdrop-blur-2xl bg-white/60 border border-white/50 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] rounded-[32px] p-8 md:p-12 overflow-hidden relative">
                    ...
                    <div className="mb-10 text-center">
                        ...
                        <p className="font-neueHaas text-gray-500 text-lg leading-snug">
                            {pendingVerification ? 'Enter the code sent to your email.' : 'Join the platform and start building.'}
                        </p>
                    </div>
                    ...
                    {!pendingVerification ? (
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full bg-[#0A0A0A] text-white font-neueHaas font-medium text-lg py-4 rounded-xl hover:bg-black hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-xl shadow-black/10 flex items-center justify-center gap-3 group mt-4 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                            >
                                {isLoading ? (
