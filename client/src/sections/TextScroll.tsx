...
const TextScroll = ({ currentTheme }) => {
    ...
    return (
        <section ref={sectionRef} className={`min-h-[80vh] flex items-center justify-center transition-colors duration-500 ${isNoir ? 'bg-[#0A0A0A]' : 'bg-[#FAFAFA]'} px-8 md:px-20 py-24 relative z-20`}>
